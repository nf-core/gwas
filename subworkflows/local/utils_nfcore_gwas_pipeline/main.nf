...
def toolCitationText(selected_methods) {
    ...
    def sentences = []
    def selected_association = (selected_methods.association ?: []).findAll { method -> association_labels.containsKey(method) }.collect { method -> association_labels[method] }.unique()
    def selected_heritability = (selected_methods.heritability ?: []).findAll { method -> heritability_labels.containsKey(method) }.collect { method -> heritability_labels[method] }.unique()
    def selected_pairwise = (selected_methods.pairwise ?: []).findAll { method -> pairwise_labels.containsKey(method) }.collect { method -> pairwise_labels[method] }.unique()
